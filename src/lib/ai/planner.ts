...
export function capabilitySystemPrompt() {
  return [
    ...
    "yc-companies: default maxItems to 50 unless the user requests fewer.",
    ...
    "A dedicated YC tool-calling orchestrator resolves batch/industry/tags/query after planning.",
    ...
    "",
    "EXAMPLES",
    '"YC companies hiring in fintech" => one yc-companies step with {isHiring:true, maxItems:50} (industry/batch filled by YC orchestrator).',
    '"YC Summer 2026 fintech companies" => one yc-companies step with {maxItems:50}; orchestrator resolves batch/industry.',
